  ...
  return (
    <>
      ...
      <div id={"shlok-information"}>
        ...
        <p>
          <span>Chapter</span>: {verse.chapter} <span>Shlok</span>:{" "}
          {verse.verse}
        </p>
      </div>
      ...
      <div className="container">
        <Accordion defaultActiveKey={["0"]}>
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>{verse.tej?.ht}</Accordion.Body>
          </Accordion.Item>
